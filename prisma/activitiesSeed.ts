        ...
        data: [
          {
            ...
            duration: "2022-12-22T10:00:00.000Z",
            placeId: e.id,
          },
          {
            name: faker.name.jobArea(),
            day: date,
            capacity: faker.datatype.number(2),
            start: "2022-12-22T10:00:00.000Z",
            duration: "2022-12-22T11:30:00.000Z",
            placeId: e.id,
          },
          {
            name: faker.name.jobArea(),
            day: date,
            capacity: faker.datatype.number(2),
            start: "2022-12-22T11:30:00.000Z",
            duration: "2022-12-22T14:00:00.000Z",
            placeId: e.id,
          },
        ],
      });
